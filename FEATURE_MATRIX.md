...
| Logcat | Package/PID targeting | Logcat controls, app-package detection | `androidDevkit.setLogcatPackageFilter`, `androidDevkit.appPackage` | Polishing | Unreleased | Defaults toward current app package and PID when available. |
